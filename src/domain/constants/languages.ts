...
export const LANGUAGES: Language[] = [
  ...
  { code: "Lithuanian", name: "Lietuvių kalba" },
  ...
  { code: "Portuguese_European", name: "Português europeu" },
  { code: "Portuguese_Brazilian", name: "Português (Brasil)" },
  { code: "Chinese", name: "中文" },
  { code: "Japanese", name: "日本語" },
  { code: "Korean", name: "한국어" },
  { code: "Hindi", name: "हिन्दी" },
  { code: "Thai", name: "ไทย" },
  { code: "Abenaki", name: "Alnôbaôdwawôgan" },
